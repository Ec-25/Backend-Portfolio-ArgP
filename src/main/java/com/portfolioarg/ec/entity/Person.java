...
public class Person {
    ...
    @NotNull
    @Size(min = 32, max = 2047, message = "does not meet the length(about > 32)")
    ...
    public Person(@NotNull @Size(min = 2, max = 63, message = "does not meet the length(2:63)") String name,
